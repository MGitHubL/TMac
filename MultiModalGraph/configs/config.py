...
class CfgNode(_CfgNode):
    ...
    def merge_from_file(self, cfg_filename: str, allow_unsafe: bool = True) -> None:
        ...
        from MultiModalGraph.configs.defaults import _C
...
def upgrade_config(cfg: CfgNode, to_version: Optional[int] = None) -> CfgNode:
    """
...
def downgrade_config(cfg: CfgNode, to_version: int) -> CfgNode:
    """
...
def guess_version(cfg: CfgNode, filename: str) -> int:
    """
