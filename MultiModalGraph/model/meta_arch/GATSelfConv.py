...
class GATSelfConv(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.edge_weight_weight = Parameter(torch.ones(1, 1))
    ...
    def forward(self, x: Union[Tensor, OptPairTensor], edge_index: Adj, edge_weight,
        ...
        alpha = alpha + edge_weight.T
        # alpha = torch.mul(alpha, self.edge_weight_weight * edge_weight.T)
